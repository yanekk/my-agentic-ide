...
**Status:** in progress — T00 ✅; T01 implemented 🔍 (awaiting review); live diffstat call hand-verified 2026-09-06.
...
| T01 | Data: listPRDiffstat + summarizeDiffstat + daemon fetch + cache triple | — | 🔍 | Client + pure summarizer + daemon shown-PR loop + tests. Non-concerning PR gets no call/no summary; transient fail keeps last triple via prevDiffstat. Suite green; live call hand-verified 2026-09-06 (cribl/sdet-tools#91, matched). |
